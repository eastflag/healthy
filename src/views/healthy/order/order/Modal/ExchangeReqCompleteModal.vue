<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <v-dialog v-model="showExchangeReqCompleteModal" content-class="rounded-0 elevation-0" width="500px">
        <v-card class="rounded-0 elevation-0 modalLayout">
            <div class="and_popup_input">
                <div class="modalTitle"><span>교환신청</span></div>
                <div class="modalBody">
                    <div class="exchangeMsg">
                        교환 신청이 완료되었습니다.
                    </div>
                    <div class="table1">
                        <table>
...
<script>
    ...
    export default {
        name: "ExchangeReqCompleteModal",
        props: [
            "showExchangeReqCompleteModal"
        ],
