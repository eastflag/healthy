    ...
    <v-container fluid class="boardLayout">
        <div class="title d-flex justify-space-between">
            ...
            <div class="selectbx">
                <select id="departure" name="departure">
                    <option value="num1" selected>가입일 최신 순</option>
        ...
        <table>
            ...
            <tr>
                ...
                <th><span>상태</span></th>
                <th><span>전문인등급</span></th>
                <th><span>전문인유형</span></th>
                <th><span>ID</span></th>
                <th><span>이름</span></th>
                <th><span>연락처</span></th>
                <th><span>가입일</span></th>
            ...
            <tr>
                ...
                <td><span>1등급</span></td>
                <td><span>약사</span></td>
                <td><span>user1</span></td>
                <td><span>김보노</span></td>
                <td><span>010-1234-5678</span></td>
                <td><span>2021-09-10</span></td>
                <td><span>서울 강서구 화곡동</span></td>
